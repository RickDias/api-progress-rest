...
*******************************************************************************/
{include/i-prgvrs.i escat001 12.00.00.000}
...
DEFINE VARIABLE h_escat001-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escat001-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escat001-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escat001-v01 ).
       RUN set-position IN h_escat001-v01 ( 2.92 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escat001-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/escat001-z01.w,
                     ProgVaPara = esp/escat001-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escat001-q01 ).
       RUN set-position IN h_escat001-q01 ( 1.25 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escat001-v01. */
       RUN add-link IN adm-broker-hdl ( h_escat001-q01 , 'Record':U , h_escat001-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escat001-v01 ).

       /* Links to SmartQuery h_escat001-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escat001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escat001-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escat001-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escat001" "12.00.00.000"}
