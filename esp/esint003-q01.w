...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-app NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-app NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-app
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-app
