...
*******************************************************************************/
{include/i-prgvrs.i ESAPI003-G01 12.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c-cod-categoria bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c-cod-categoria 
...
DEFINE VARIABLE c-cod-categoria AS CHARACTER FORMAT "X(256)":U 
     LABEL "C¢digo Categoria" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c-cod-categoria AT ROW 2.04 COL 17 COLON-ALIGNED WIDGET-ID 2
...
DO:
    IF INPUT FRAME {&FRAME-NAME} c-cod-categoria <> ""
    THEN FIND FIRST es-categoria-item NO-LOCK
         WHERE es-categoria-item.cod-categoria  EQ INPUT FRAME {&FRAME-NAME} c-cod-categoria
         NO-ERROR.
    
    IF NOT AVAILABLE es-categoria-item 
    THEN DO:
        {utp/ut-table.i mgcam es-categoria-item 1}
        RUN utp/ut-msgs.p(INPUT "show",
                          INPUT 2,
                          INPUT RETURN-VALUE).
        RETURN NO-APPLY.
    END.
    ASSIGN p-row-tabela = ROWID(es-categoria-item).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c-cod-categoria 
      WITH FRAME d-vapara.
  ENABLE rt-button c-cod-categoria bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPI003-G01" "12.00.00.000"}
