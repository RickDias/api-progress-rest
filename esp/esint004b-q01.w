...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-request NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-request NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-request
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-request
