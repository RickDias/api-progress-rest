...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-schedule NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-schedule NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-schedule
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-schedule
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcam.es-api-schedule"
     _Options          = "NO-LOCK"
