...
*******************************************************************************/
{include/i-prgvrs.i esint015-G01 12.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cd-tipo-integr bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cd-tipo-integr 
...
DEFINE VARIABLE i_cd-tipo-integr AS INTEGER FORMAT ">,>>>,>>9":U 
...
DEFINE FRAME d-vapara
     i_cd-tipo-integr AT ROW 1.79 COL 30 COLON-ALIGNED WIDGET-ID 2
...
DO:
   FIND es-api-schedule NO-LOCK
       WHERE es-api-schedule.cd-tipo-integr EQ INPUT FRAME {&FRAME-NAME} i_cd-tipo-integr NO-ERROR.
   
   IF NOT AVAILABLE es-api-schedule THEN DO:
       {utp/ut-table.i mgcam es-api-schedule 1}
       RUN utp/ut-msgs.p(INPUT "show",
                         INPUT 2,
                         INPUT RETURN-VALUE).
       RETURN NO-APPLY.
   END.
   ASSIGN p-row-tabela = ROWID(es-api-schedule).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cd-tipo-integr 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cd-tipo-integr bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint015-G01" "12.00.00.000"}
