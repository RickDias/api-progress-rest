...
*******************************************************************************/
{include/i-prgvrs.i ESCAT001-Z01 12.00.00.000}
...
DEFINE VARIABLE h_ESCAT001-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ESCAT001-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ESCAT001-b01 ).
       RUN set-position IN h_ESCAT001-b01 ( 3.50 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_ESCAT001-b01. */
       RUN add-link IN adm-broker-hdl ( h_ESCAT001-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ESCAT001-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCAT001-Z01" "12.00.00.000"}
