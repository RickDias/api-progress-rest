...
/*         contrato-for.log-libera          = tt-imp-contrato-for.log-libera  */
    ...
    ASSIGN matriz-rat-contr.nr-contrato         = i-num-contrato
...
/*         VIEW-AS ALERT-BOX INFO BUTTONS OK. */
    ...
    ASSIGN item-contrat.cod-emitente            = tt-imp-contrato-for.cod-emitente
           item-contrat.nr-contrato             = i-num-contrato
    ...
    ASSIGN matriz-rat-item.nr-contrato          = i-num-contrato
...
PROCEDURE pi-geraPedidoContrato.
    ...
    ASSIGN tt-pedido-compr.num-pedido              =  i-num-pedido
           ...
           tt-pedido-compr.char-2                  =  STRING(i-num-contrato)
       ...
       /*INCLUS€O*/
        ...
        CASE tt-imp-contrato-for.ind-tipo-movto:
            WHEN 1 THEN DO: // Inclusao de registro
                ...
                IF string(tt-imp-contrato-for.nr-contrato) <> "0" AND string(tt-imp-contrato-for.nr-contrato) <> "" OR string(tt-imp-contrato-for.nr-contrato) <> ? THEN DO:
