...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-tipo-ped-compra NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-tipo-ped-compra NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-tipo-ped-compra
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-tipo-ped-compra
