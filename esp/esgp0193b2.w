...
&Scoped-define INTERNAL-TABLES es-gp-mix-vendedor

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-gp-mix-vendedor.cod-emitente ~
fncNomeEmit(es-gp-mix-vendedor.cod-emitente) @ c-nome-emit 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es-gp-mix-vendedor OF es-gp-mix WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es-gp-mix-vendedor OF es-gp-mix WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table es-gp-mix-vendedor
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-gp-mix-vendedor
...
<FOREIGN-KEYS>
cod-rep||y|mgcam.es-gp-mix-vendedor.cod-rep
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fncNomeEmit B-table-Win 
FUNCTION fncNomeEmit RETURNS CHARACTER ( INPUT pc-cod-emitente AS INTEGER ) FORWARD.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es-gp-mix-vendedor.cod-emitente FORMAT ">>>>>>>>9":U
      fncNomeEmit(es-gp-mix-vendedor.cod-emitente) @ c-nome-emit
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgcam.es-gp-mix-vendedor OF mgcam.es-gp-mix"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = mgcam.es-gp-mix-vendedor.cod-emitente
     _FldNameList[2]   > "_<CALC>"
"fncNomeEmit(es-gp-mix-vendedor.cod-emitente) @ c-nome-emit" ? ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-rep" "es-gp-mix-vendedor" "cod-rep"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fncNomeEmit B-table-Win 
FUNCTION fncNomeEmit RETURNS CHARACTER ( INPUT pc-cod-emitente AS INTEGER ):
                                      
    FOR FIRST emitente FIELD(nome-emit)
        WHERE emitente.cod-emitente = INT(pc-cod-emitente) NO-LOCK:
