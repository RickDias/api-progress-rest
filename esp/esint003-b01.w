...
&Scoped-define INTERNAL-TABLES es-api-app

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-api-app.cd-sistema es-api-app.des-sistema   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH es-api-app NO-LOCK         WHERE es-api-app.cd-sistema >= i-inicial           AND es-api-app.cd-sistema <= i-final     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME}      FOR EACH es-api-app NO-LOCK         WHERE es-api-app.cd-sistema >= i-inicial           AND es-api-app.cd-sistema <= i-final     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table es-api-app
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-api-app
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      es-api-app.cd-sistema  FORMAT ">,>>>,>>9":U
      es-api-app.des-sistema FORMAT "x(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
OPEN QUERY {&SELF-NAME}
     FOR EACH es-api-app NO-LOCK
        WHERE es-api-app.cd-sistema >= i-inicial
          AND es-api-app.cd-sistema <= i-final
