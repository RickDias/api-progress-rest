...
*******************************************************************************/
{include/i-prgvrs.i esint015-Z01 12.00.00.000}
...
DEFINE VARIABLE h_esint015-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint015-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint015-b01 ).
       RUN set-position IN h_esint015-b01 ( 3.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 87.00 ) */

       /* Links to SmartBrowser h_esint015-b01. */
       RUN add-link IN adm-broker-hdl ( h_esint015-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint015-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint015-Z01" "12.00.00.000"}
