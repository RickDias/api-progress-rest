...
*******************************************************************************/
{include/i-prgvrs.i esint004-Z01 12.00.00.000}
...
DEFINE VARIABLE h_esint004-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint004-b04 AS HANDLE NO-UNDO.
...
/* SETTINGS FOR BUTTON bt-implantar IN FRAME f-zoom
   NO-ENABLE                                                            */
ASSIGN 
       bt-implantar:HIDDEN IN FRAME f-zoom           = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint004-b01 ).
       RUN set-position IN h_esint004-b01 ( 3.08 , 5.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esint004-b01. */
       RUN add-link IN adm-broker-hdl ( h_esint004-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-b04.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint004-b04 ).
       RUN set-position IN h_esint004-b04 ( 3.25 , 5.14 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esint004-b04. */
       RUN add-link IN adm-broker-hdl ( h_esint004-b04 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004-b04 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint004-Z01" "12.00.00.000"}
