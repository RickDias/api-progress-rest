...
*******************************************************************************/
{include/i-prgvrs.i esint004 12.00.00.000}
...
DEFINE VARIABLE h_esint004-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint004-b03 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint004-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint004-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 107.29 BY 22.71 WIDGET-ID 100.
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 91.29 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint004-v01 ).
       RUN set-position IN h_esint004-v01 ( 2.88 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 11.25 , 106.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Request|Response' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 14.25 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.25 , 106.43 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esint004-z01.w,
                     ProgVaPara = esp/esint004-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esint004-q01 ).
       RUN set-position IN h_esint004-q01 ( 1.33 , 62.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esint004-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint004-q01 , 'Record':U , h_esint004-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esint004-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esint004-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esint004-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esint004-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esint004-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-b02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/esint004a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esint004-b02 ).
       RUN set-position IN h_esint004-b02 ( 15.71 , 2.86 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 104.00 ) */

       /* Links to BrowserCadastro2 h_esint004-b02. */
       RUN add-link IN adm-broker-hdl ( h_esint004-q01 , 'Record':U , h_esint004-b02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004-b03.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     Hide-on-Init = no,
                     Disable-on-Init = no,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/esint004b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esint004-b03 ).
       RUN set-position IN h_esint004-b03 ( 15.75 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 104.00 ) */

       /* Links to BrowserCadastro2 h_esint004-b03. */
       RUN add-link IN adm-broker-hdl ( h_esint004-q01 , 'Record':U , h_esint004-b03 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint004" "12.00.00.000"}
