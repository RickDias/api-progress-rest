...
*******************************************************************************/
{include/i-prgvrs.i ESPD002 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESPD002 MPD}
&ENDIF
...
DEFINE VARIABLE cod-rep-fim AS INTEGER FORMAT ">>>>9":U INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE cod-rep-ini AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Cod. Repr." 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE dt-entr-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/99 
     LABEL "Dt. Entrega" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-entr-orig-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE dt-entr-orig-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/99 
     LABEL "Dt. Entr. Orgin" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-ini AS CHARACTER FORMAT "X(12)":U 
     LABEL "Pedido" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-rep-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-rep-ini AS CHARACTER FORMAT "X(12)":U 
     LABEL "Ped. Repres" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-sal-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ped-sal-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Ped. Sales" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ped-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     ped-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     ped-rep-ini AT ROW 2.25 COL 15 COLON-ALIGNED WIDGET-ID 2
     ped-rep-fim AT ROW 2.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     ped-sal-ini AT ROW 3.25 COL 15 COLON-ALIGNED WIDGET-ID 10
     ped-sal-fim AT ROW 3.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     dt-entr-orig-ini AT ROW 4.25 COL 15 COLON-ALIGNED WIDGET-ID 40
     dt-entr-orig-fim AT ROW 4.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     dt-entr-ini AT ROW 5.25 COL 15 COLON-ALIGNED WIDGET-ID 20
     dt-entr-fim AT ROW 5.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     cod-rep-ini AT ROW 6.25 COL 15 COLON-ALIGNED WIDGET-ID 36
     cod-rep-fim AT ROW 6.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 2.25 COL 31.86 WIDGET-ID 4
     IMAGE-4 AT ROW 2.25 COL 47.29 WIDGET-ID 6
     IMAGE-5 AT ROW 3.25 COL 31.86 WIDGET-ID 12
     IMAGE-6 AT ROW 3.25 COL 47.29 WIDGET-ID 14
     IMAGE-7 AT ROW 4.25 COL 31.86 WIDGET-ID 22
     IMAGE-8 AT ROW 4.25 COL 47.29 WIDGET-ID 24
     IMAGE-9 AT ROW 5.25 COL 31.86 WIDGET-ID 26
     IMAGE-10 AT ROW 5.25 COL 47.29 WIDGET-ID 28
     IMAGE-11 AT ROW 6.25 COL 31.86 WIDGET-ID 30
     IMAGE-12 AT ROW 6.25 COL 47.29 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESPD002" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY ped-ini ped-fim ped-rep-ini ped-rep-fim ped-sal-ini ped-sal-fim 
          dt-entr-orig-ini dt-entr-orig-fim dt-entr-ini dt-entr-fim cod-rep-ini 
          cod-rep-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 ped-ini ped-fim ped-rep-ini 
         ped-rep-fim ped-sal-ini ped-sal-fim dt-entr-orig-ini dt-entr-orig-fim 
         dt-entr-ini dt-entr-fim cod-rep-ini cod-rep-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*                                             rs-classif:radio-buttons in frame f-pg-cla) */
    ...
    ASSIGN tt-param.ped-ini           = INPUT FRAME f-pg-sel ped-ini         
           tt-param.ped-fim           = INPUT FRAME f-pg-sel ped-fim         
           tt-param.ped-rep-ini       = INPUT FRAME f-pg-sel ped-rep-ini     
           tt-param.ped-rep-fim       = INPUT FRAME f-pg-sel ped-rep-fim     
           tt-param.ped-sal-ini       = INPUT FRAME f-pg-sel ped-sal-ini     
           tt-param.ped-sal-fim       = INPUT FRAME f-pg-sel ped-sal-fim     
           tt-param.dt-entr-orig-ini  = INPUT FRAME f-pg-sel dt-entr-orig-ini
           tt-param.dt-entr-orig-fim  = INPUT FRAME f-pg-sel dt-entr-orig-fim
           tt-param.dt-entr-ini       = INPUT FRAME f-pg-sel dt-entr-ini     
           tt-param.dt-entr-fim       = INPUT FRAME f-pg-sel dt-entr-fim     
           tt-param.cod-rep-ini       = INPUT FRAME f-pg-sel cod-rep-ini     
           tt-param.cod-rep-fim       = INPUT FRAME f-pg-sel cod-rep-fim.
    .MESSAGE 
        "INPUT FRAME f-pg-sel ped-ini  " INPUT FRAME f-pg-sel ped-ini SKIP
        "INPUT FRAME f-pg-sel ped-fim  " INPUT FRAME f-pg-sel ped-fim SKIP
        "INPUT FRAME f-pg-sel abr-ini  " INPUT FRAME f-pg-sel abr-ini SKIP
        "INPUT FRAME f-pg-sel abr-fim  " INPUT FRAME f-pg-sel abr-fim SKIP
        "INPUT FRAME f-pg-sel ite-ini  " INPUT FRAME f-pg-sel ite-ini SKIP
        "INPUT FRAME f-pg-sel ite-fim  " INPUT FRAME f-pg-sel ite-fim SKIP
    ...
    {include/i-rprun.i esp/espd002rp.p}
