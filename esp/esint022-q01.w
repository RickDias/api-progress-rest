...
&Scoped-define INTERNAL-TABLES es-ariba-b2e-param

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-ariba-b2e-param NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-ariba-b2e-param NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-ariba-b2e-param
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-ariba-b2e-param
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcam.es-ariba-b2e-param"
     _Options          = "NO-LOCK"
