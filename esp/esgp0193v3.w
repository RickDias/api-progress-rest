...
/*               END.                                                     */
    ...
    IF AVAIL es-gp-mix-vendedor THEN DO:
       ...
       IF AVAIL es-api-param THEN DO:
          ...
          IF NOT CAN-FIND(FIRST es-api-export WHERE es-api-export.chave = string(es-gp-mix-vendedor.cod-rep)
             ...
             ASSIGN es-api-export-repres.cd-tipo-integr = es-api-param.cd-tipo-integr
                    ...
                    es-api-export-repres.cod-rep        = es-gp-mix-vendedor.cod-rep           
