...
*******************************************************************************/
{include/i-prgvrs.i ESGP0199B1 2.09.00.001 } /*** 010001 ***/
...
DEFINE VARIABLE c-desc-cond-pag LIKE cond-pagto.descricao NO-UNDO.
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES es-gp-emitente
&Scoped-define FIRST-EXTERNAL-TABLE es-gp-emitente


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR es-gp-emitente.
/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES es-gp-emit-cond-pagto

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-gp-emit-cond-pagto.cod-cond-pag ~
FncDescPagto(es-gp-emit-cond-pagto.cod-cond-pag) @ c-desc-cond-pag 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es-gp-emit-cond-pagto OF es-gp-emitente WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es-gp-emit-cond-pagto OF es-gp-emitente WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table es-gp-emit-cond-pagto
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-gp-emit-cond-pagto
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD FncDescPagto B-table-Win 
FUNCTION FncDescPagto RETURNS CHARACTER ( INPUT pi-cod-cond-pag AS INT )  FORWARD.
...
DEFINE QUERY br-table FOR 
      es-gp-emit-cond-pagto SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es-gp-emit-cond-pagto.cod-cond-pag FORMAT ">>>9":U
      FncDescPagto(es-gp-emit-cond-pagto.cod-cond-pag) @ c-desc-cond-pag COLUMN-LABEL "Descri‡Æo"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   External Tables: es-gp-emitente
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "es-gp-emit-cond-pagto OF es-gp-emitente"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = es-gp-emit-cond-pagto.cod-cond-pag
     _FldNameList[2]   > "_<CALC>"
"FncDescPagto(es-gp-emit-cond-pagto.cod-cond-pag) @ c-desc-cond-pag" "Descri‡Æo" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    IF AVAIL es-gp-emit-cond-pagto THEN 
        ASSIGN i-cod-emitente = es-gp-emit-cond-pagto.cod-emitente.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "es-gp-emitente"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "es-gp-emitente"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "es-gp-emitente"}
        ...
        IF AVAIL emitente THEN DO:
            ...
            IF (emitente.identific = 1 OR emitente.identific = 3) AND emitente.natureza = 2 THEN DO:
                ...
                IF AVAIL es-api-param THEN DO:
                    ...
                    IF (NOT CAN-FIND(FIRST sfa-export WHERE sfa-export.chave = emitente.cgc
                        ...
                        ASSIGN sfa-export-cli.cd-tipo-integr = es-api-param.cd-tipo-integr
                               ...
                               sfa-export-cli.cgc            = emitente.cgc
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION FncDescPagto B-table-Win 
FUNCTION FncDescPagto RETURNS CHARACTER ( INPUT pi-cod-cond-pag AS INT ) :                                   

    FOR FIRST cond-pagto FIELD(descricao)
        WHERE cond-pagto.cod-cond-pag = pi-cod-cond-pag NO-LOCK:
