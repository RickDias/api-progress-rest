...
*******************************************************************************/
{include/i-prgvrs.i esint005 12.00.00.000}
...
DEFINE VARIABLE h_esint005-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint005-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.86 BY 10.21 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint005-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint005-v01 ).
       RUN set-position IN h_esint005-v01 ( 2.92 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 7.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint005-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esint005-z01.w,
                     ProgVaPara = esp/esint005-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esint005-q01 ).
       RUN set-position IN h_esint005-q01 ( 1.25 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esint005-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint005-q01 , 'Record':U , h_esint005-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esint005-v01 ).

       /* Links to SmartQuery h_esint005-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esint005-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esint005-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint005-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint005" "12.00.00.000"}
