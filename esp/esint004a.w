...
*******************************************************************************/
{include/i-prgvrs.i esint004A 12.00.00.000}
...
DEFINE VARIABLE h_esint004a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint004a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 14.5 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 14.5 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 14.5 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 14.5 COL 79.43
     rt-button AT ROW 14.33 COL 1.57
...
DO:
   {include/okfil.i h_esint004a-v01}
END.
...
DO:
   {include/salvafil.i h_esint004a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint004a-v01 ).
       RUN set-position IN h_esint004a-v01 ( 1.13 , 1.29 ) NO-ERROR.
       /* Size in UIB:  ( 13.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esint004a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esint004a-q01 ).
       RUN set-position IN h_esint004a-q01 ( 14.13 , 63.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 7.72 ) */

       /* Links to SmartViewer h_esint004a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint004a-q01 , 'Record':U , h_esint004a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esint004a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint004a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esint004A" "12.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esint004a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esint004a-q01 (input v-row-table).
