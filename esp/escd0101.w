...
*******************************************************************************/
{include/i-prgvrs.i escd0101 0.00.00.001}
...
DEFINE VARIABLE h_escd0101-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escd0101-v01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Tipos de Pedidos de Compra"
         HEIGHT             = 5.33
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Tipos de Pedidos de Compra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Tipos de Pedidos de Compra */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esvwr/escd0101-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escd0101-v01 ).
       RUN set-position IN h_escd0101-v01 ( 2.83 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escd0101-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp\escd0101-z01.w,
                     ProgVaPara = esp\escd0101-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escd0101-q01 ).
       RUN set-position IN h_escd0101-q01 ( 1.25 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 14.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escd0101-v01. */
       RUN add-link IN adm-broker-hdl ( h_escd0101-q01 , 'Record':U , h_escd0101-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escd0101-v01 ).

       /* Links to SmartQuery h_escd0101-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escd0101-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escd0101-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escd0101-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escd0101-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escd0101" "0.00.00.001"}
