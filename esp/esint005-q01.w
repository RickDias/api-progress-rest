...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-token-apigee NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-token-apigee NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-token-apigee
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-token-apigee
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcam.es-api-token-apigee"
     _Options          = "NO-LOCK"
