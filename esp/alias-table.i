...
CREATE ALIAS movadm FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movdis FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movfis FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movind FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movmfg FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movmnt FOR DATABASE movmov NO-ERROR.
CREATE ALIAS wmovdis FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movfro FOR DATABASE movmov NO-ERROR.
CREATE ALIAS movdbr FOR DATABASE movmov NO-ERROR.
