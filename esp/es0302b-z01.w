...
&Scoped-define FIELDS-IN-QUERY-br-table es-api-schedule.cd-tipo-integr es-api-schedule.data-inicio es-api-schedule.hora-inicio es-api-schedule.data-fim es-api-schedule.hora-fim es-api-schedule.ativo   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH es-api-schedule NO-LOCK        WHERE ~{&KEY-PHRASE}     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME}     FOR EACH es-api-schedule NO-LOCK        WHERE ~{&KEY-PHRASE}     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      es-api-schedule.cd-tipo-integr FORMAT ">,>>>,>>9":U
      es-api-schedule.data-inicio    FORMAT "99/99/9999":U
      es-api-schedule.hora-inicio 
      es-api-schedule.data-fim       FORMAT "99/99/9999":U
      es-api-schedule.hora-fim      
