...
*******************************************************************************/
{include/i-prgvrs.i esint014 12.00.00.000}
...
DEFINE VARIABLE da-periodo-fim AS DATETIME FORMAT "99/99/9999 HH:MM:SS":U INITIAL "12/31/9999 23:59:59.000" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE da-periodo-ini AS DATETIME FORMAT "99/99/9999 HH:MM:SS":U INITIAL "01/01/001 00:00:00.000" 
     LABEL "Per°odo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cd-sistema-fim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cd-sistema-ini AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Sistema" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cd-tipo-integr-fim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cd-tipo-integr-ini AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Tipo de Integraá∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-relat AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Importaá∆o", 1,
"Exportaá∆o", 2
...
DEFINE VARIABLE l-integrado AS LOGICAL INITIAL no 
     LABEL "Integrado" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.

DEFINE VARIABLE l-nao-integrado AS LOGICAL INITIAL no 
     LABEL "N∆o Integrado" 
     VIEW-AS TOGGLE-BOX
     SIZE 11.57 BY .83 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     i-relat AT ROW 2.08 COL 16.86 NO-LABEL WIDGET-ID 2
     i-cd-tipo-integr-ini AT ROW 3.33 COL 14.57 COLON-ALIGNED
     i-cd-tipo-integr-fim AT ROW 3.33 COL 47.72 COLON-ALIGNED NO-LABEL
     i-cd-sistema-ini AT ROW 4.29 COL 14.57 COLON-ALIGNED WIDGET-ID 12
     i-cd-sistema-fim AT ROW 4.29 COL 47.72 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     l-integrado AT ROW 5.29 COL 16.43 WIDGET-ID 18
     l-nao-integrado AT ROW 6.08 COL 16.43 WIDGET-ID 20
     da-periodo-ini AT ROW 7 COL 14.57 COLON-ALIGNED WIDGET-ID 24
     da-periodo-fim AT ROW 7 COL 47.72 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     "Tipo de Relat¢rio:" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 2.29 COL 4 WIDGET-ID 6
     IMAGE-1 AT ROW 3.33 COL 31.43
     IMAGE-2 AT ROW 3.33 COL 46.86
     IMAGE-3 AT ROW 4.29 COL 31.43 WIDGET-ID 14
     IMAGE-4 AT ROW 4.29 COL 46.86 WIDGET-ID 16
     IMAGE-5 AT ROW 7 COL 31.43 WIDGET-ID 26
     IMAGE-6 AT ROW 7 COL 46.86 WIDGET-ID 28
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esint014" "12.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-relat i-cd-tipo-integr-ini i-cd-tipo-integr-fim i-cd-sistema-ini 
          i-cd-sistema-fim l-integrado l-nao-integrado da-periodo-ini 
          da-periodo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 i-relat 
         i-cd-tipo-integr-ini i-cd-tipo-integr-fim i-cd-sistema-ini 
         i-cd-sistema-fim l-integrado l-nao-integrado da-periodo-ini 
         da-periodo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario              = c-seg-usuario
           ...
           tt-param.i-cd-sistema-fim     = input frame f-pg-sel i-cd-sistema-fim     
           tt-param.i-cd-sistema-ini     = input frame f-pg-sel i-cd-sistema-ini    
           tt-param.da-periodo-fim       = input frame f-pg-sel da-periodo-fim      
           tt-param.da-periodo-ini       = input frame f-pg-sel da-periodo-ini      
           tt-param.i-cd-tipo-integr-fim = input frame f-pg-sel i-cd-tipo-integr-fim
           tt-param.i-cd-tipo-integr-ini = input frame f-pg-sel i-cd-tipo-integr-ini
           tt-param.i-relat              = input frame f-pg-sel i-relat             
           tt-param.l-integrado          = input frame f-pg-sel l-integrado         
           tt-param.l-nao-integrado      = input frame f-pg-sel l-nao-integrado     
           .
    ...
    {include/i-rprun.i esp/esint014rp.p}
