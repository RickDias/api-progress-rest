...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-categoria-item NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-categoria-item NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-categoria-item
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-categoria-item
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcam.es-categoria-item"
     _Options          = "NO-LOCK"
