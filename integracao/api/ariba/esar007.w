...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportaá∆o Recebimento Fisico"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF w-relat /* Exportaá∆o Recebimento Fisico */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exportaá∆o Recebimento Fisico */
DO:
...
{utp/ut9000.i "esar007" "2.06.00.001"}
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i integracao/api/ariba/esar007rp.p}
