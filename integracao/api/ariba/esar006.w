...
ON END-ERROR OF w-relat /* Consulta Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Consulta Fornecedor */
DO:
...
{utp/ut9000.i "ESAR006" "2.06.00.001"}
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i integracao/api/ariba/esar006rp.p}
