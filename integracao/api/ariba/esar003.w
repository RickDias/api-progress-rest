...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportaá∆o Taxa Convers∆o"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 205.72
...
ON END-ERROR OF w-relat /* Exportaá∆o Taxa Convers∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exportaá∆o Taxa Convers∆o */
DO:
