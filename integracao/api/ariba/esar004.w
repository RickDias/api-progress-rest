...
ON END-ERROR OF w-relat /* Exportaá∆o Item Network */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exportaá∆o Item Network */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i integracao/api/ariba/esar004rp.p}
